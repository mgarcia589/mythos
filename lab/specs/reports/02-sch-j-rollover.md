...
engine.sch_j_rollover(entity="Alpha")
...
║  Sample Client | FY2024 → FY2025 | 66 entities             ║
╠══════════════════════════════════════════════════════════════════════════════════╣
║                                                                                ║
...
║  ─────────────────────────────────────────────────────────────────────────────  ║
║  Alpha Europe Limited         (a) Post-2017 Not Prev Tax      +1,245,830   ║
║  Alpha Europe Limited         (h) Total 964(a) E&P            +1,245,830   ║
║  Gamma Holdings Ltd               (a) Post-2017 Not Prev Tax        -582,100   ║
║  ...                                                                           ║
║                                                                                ║
╚══════════════════════════════════════════════════════════════════════════════════╝
```
...
```
┌─────────────────────────────────────────────────────────────────────────────────────┐
│ Entity: Alpha Europe Limited (C0003) | FC: GBP                                    │
├──────┬────────────────────────────────────┬──────────────┬──────────────┬───────────┬────────┐
...
```
┌─── Page 1 of 3 ───────────────────────────────────────────────────────────┐
│ Schedule J Rollover — Sample Client FY24→FY25                              │
│                                                                           │
│                    │     Pool (a)              │     Pool (b)              │
│                    │  Post-2017 Not Prev Tax   │  Post-2017 Prev Taxed    │
│ Entity             │  PY XML │  CY XML │Status│  PY XML │  CY XML │Status│
│ ───────────────────┼─────────┼─────────┼──────┼─────────┼─────────┼──────│
│ Alpha Europe    │12,450,000│13,695,830│Review│     0  │      0  │  OK  │
│ Gamma Holdings      │ 5,000,000│ 4,417,900│Review│     0  │      0  │  OK  │
│ Beta Corp   │ 2,300,000│ 2,300,000│  OK  │     0  │      0  │  OK  │
│ ...                │         │         │      │         │         │      │
│                                                                           │
...
┌─── Page 2 of 3 ───────────────────────────────────────────────────────────┐
│ Schedule J Rollover — Sample Client FY24→FY25 (continued)                  │
│                                                                           │
│                    │   Pool (d)                │  Pool (e)(i)              │
│                    │  Section 245A(d) PTEP     │  951(a)(1)(A) Sub F PTEP  │
│ Entity             │  PY XML │  CY XML │Status│  PY XML │  CY XML │Status│
│ ───────────────────┼─────────┼─────────┼──────┼─────────┼─────────┼──────│
│ Alpha Europe    │      0  │      0  │  OK  │  800,000│  800,000│  OK  │
│ Gamma Holdings      │      0  │      0  │  OK  │  200,000│  200,000│  OK  │
│ Beta Corp   │      0  │      0  │  OK  │      0  │      0  │  OK  │
│ ...                │         │         │      │         │         │      │
│                                                                           │
...
- [ ] Sample Client FY24→FY25: genera tabla por cada entity con Sch J data
