...
┌──────────────────────────────────────────────────────────────────────────────┐
│                                                                              │
│  CLIENT:       Sample Client LP                          │
│  ENGAGEMENT:   FY25 International Tax Compliance                │
...
║  ────────────────────────────────────────────────────────────────────────── ║
║  Alpha Europe Limited    1d     Incorporation date    2011-04-01→04-02  ║
║  Gamma Holdings Ltd          1a     Address line 1        22 Grenville→(empty)║
║  Gamma Holdings Ltd          1a     City                  St Helier→(empty) ║
║  Gamma Holdings Ltd          1a     Country               JE → (empty)     ║
║  Beta Corp Ltd        1h     Functional currency   EUR → GBP        ║
║  ...                                                                       ║
║                                                                            ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
```
┌──────────────────────────────────────────────────────────────────────────────────────┐
│ Entity: Alpha Europe Limited (C0003) | Form: 5471                                  │
├──────┬─────────────────────────────────┬───────────────────┬───────────────────┬────────┐
│ Line │ Description                     │       PY          │       CY          │ Status │
├──────┼─────────────────────────────────┼───────────────────┼───────────────────┼────────┤
│ 1a   │ Name of foreign corporation     │ Alpha Europe   │ Alpha Europe   │   OK   │
...
- [ ] Sample Client FY24→FY25: detecta 8 cambios
- [ ] Orden de campos = orden de la forma impresa (1a name → 1a addr → ... → 4 category)
- [ ] Gamma Holdings: address fields show "(empty)" en CY column
- [ ] Beta Corp: functional currency EUR→GBP flagged
- [ ] Alpha: incorporation date 2011-04-01→2011-04-02 flagged
