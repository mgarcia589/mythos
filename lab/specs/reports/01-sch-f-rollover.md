...
engine.sch_f_rollover(entity="Beta Solutions") # By name (partial match)
...
engine.sch_f_rollover(entities=["Alpha", "Beta"])  # Partial match each
```
...
║  ─────────────────────────────────────────────────────────────────────────  ║
║  Alpha Europe Limited         9       Total assets           +15,420    ║
║  Gamma Holdings Ltd               15      Retained earnings     -82,000    ║
║  Beta Crumlin Ltd             1       Cash                  +10,500    ║
║                                                                            ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
...
```
┌──────────────────────────────────────────────────────────────────────────────────┐
│ Entity: Beta Solutions Videcart SAU (C0045) | FC: EUR                          │
├──────┬─────────────────────────────────┬──────────────┬──────────────┬───────────┬────────┐
...
- [ ] Sample Client FY24→FY25: 14 rounding diffs detectadas (consistente con demo actual)
- [ ] Todas las diffs de CB son ±1-2 (severity = rounding)
- [ ] Other Client XML: no tiene Sch F → report gracefully skips
