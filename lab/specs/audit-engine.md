...
- Entity registry pre-loaded with sample client data (36 entities hardcoded)
...
2. `core/entity_registry.py` — EntityRegistry with sample client pre-load ✅
...
10. `tests/test_ep_validator.py` — Unit tests with known sample client values ⏳

## Verification Criteria

- [ ] `run_audit.py` on the sample client workbook detects ALL 6 known critical issues
